...
const POLLUX = new Client( { //)
  ...
  //shards:SHARDS,
   // shardCount: 4 ,
    ...
    //restTimeOffset:1,
    ws:{compress:true,large_threshold:1},
...
//*/
POLLUX.login(cfg.token_e).then(loginSuccess).catch(e=> {console.error(e); POLLUX.ready=true });
...
//POLLUX.shard.id = POLLUX.options.shards[0]
POLLUX.once('ready', ()=>{
